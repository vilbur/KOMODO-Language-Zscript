# Registers the Zscript language in Komodo.

import logging
from koUDLLanguageBase import KoUDLLanguage

log = logging.getLogger("koZscriptLanguage")
#log.setLevel(logging.DEBUG)

def registerLanguage(registry):
    log.debug("Registering language Zscript")
    registry.registerLanguage(KoZscriptLanguage())

class KoZscriptLanguage(KoUDLLanguage):

    # ------------ Komodo Registration Information ------------ #

    name = "Zscript"
    lexresLangName = "Zscript"
    ...
    #           'M': 'XML',             #   XML
    #        }
    lang_from_udl_family = {'SSL': 'Zscript'}
